                        ...
                        <div class="post-single-body">
                            ...
                            <div class="post-single-title">
                                ...
                                <ul class="entry-meta">
                                    ...
                                    <li class="post-author"> <a href="author.html">
                                        {{ $post_details->first()->rel_to_user->name }}
                                    </a></li>

                                    <li class="entry-cat"> <a href="blog-layout-1.html" class="category-style-1 "> <span class="line"></span>
                                        {{ $post_details->first()->rel_to_category->category_name }}
                                    </a></li>
